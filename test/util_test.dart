    ...
    test('Same document', () {
      expect(
        Uri.parse('http://example.com')
            .sameDocument(Uri.parse('http://example.com')),
        isTrue,
      );
      expect(
        Uri.parse('http://example.com/')
      ...
      expect(
        Uri.parse('http://example.com/path')
            .sameDocument(Uri.parse('http://example.com/path')),
        isTrue,
      );
      expect(
        Uri.parse('http://example.com/path/')
      ...
      expect(
        Uri.parse('http://example.com/path?query=1')
            .sameDocument(Uri.parse('http://example.com/path')),
        isTrue,
      );
      expect(
        Uri.parse('http://example.com/path#fragment')
            .sameDocument(Uri.parse('http://example.com/path')),
        isTrue,
      );
      expect(
